...
export const Header = ({
  ...
  return (
    <header className="relative">
      <div className={`${sectionClasses} sm:h-screen sm:absolute sm:z-40 sm:top-0 sm:left-0 sm:right-0`}>
        <div style={backgroundStyles} className={`${backgroundClasses} ${nav.navBackgroundColor} opacity-100 absolute inset-0 -z-1 block sm:hidden`}></div>
        ...
        <nav className={`max-w-desktop-full mx-auto ${nav?.padding}`}>
